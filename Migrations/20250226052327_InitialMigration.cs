    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocalHomes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LocalHomes_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTourGuideBookings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserTourGuideBookings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserTourGuideBookings_TourGuides_TourGuideId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTourGuideBookings_TourGuideId",
                table: "UserTourGuideBookings",
                column: "TourGuideId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTourGuideBookings_UserId",
                table: "UserTourGuideBookings",
                column: "UserId");
        }
